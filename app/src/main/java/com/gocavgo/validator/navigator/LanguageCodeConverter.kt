...
object LanguageCodeConverter {
    ...
    private lateinit var languageCodeMap: MutableMap<LanguageCode, Locale>
    ...
    fun getLanguageCode(locale: Locale): LanguageCode {
        ...
        for ((languageCode, localeEntry) in languageCodeMap) {
    ...
    private fun initLanguageCodeMap() {
        this.languageCodeMap = mutableMapOf()
        ...
        languageCodeMap[LanguageCode.PRS_ARAB_AF] =
            Locale("prs", "ARAB_AF")
        ...
        languageCodeMap[LanguageCode.QUC_LATN_GT] =
            Locale("quc", "LATN_GT")
